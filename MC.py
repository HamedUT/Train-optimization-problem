...
def calculate_combined_journey_exact_time(total_distance, delta_t, speed_limit, max_acc, max_braking, m, C_d, A, C, eta, WindSpeed, v_init, max_p, braking_eff, total_time, plot=False):
    ...
    return distances_final,velocities_final, powers_final, braking_speed_final, distance_final, total_time_final, times_final
...
if __name__ == "__main__":
    ...
    difference = 10000000
    delta_s = 30 # should be the same with Train.py if i want the output be the input of initializer
...
for speed_limit in [i * 0.2 for i in range(0, 5*int(speed_limit_allowed) + 1)]:  # Increment by 0.1 m/s
    ...
    distances,velocities, powers, braking_speed_final, distance_final, total_time_final, times_final = calculate_combined_journey_exact_time(total_distance, delta_t, speed_limit, max_acc, max_braking, m, C_d, A, C, eta, WindSpeed, v_init, max_p, braking_eff, total_time, plot=False)    
...
# Pass times_final_final to plotting
