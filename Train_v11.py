...
# v11: Considered a scenario where it simulates in the middle of the journey, where the initial velocity, time remaining, and distance remaining are different. also adding the effect of substation limitation again
